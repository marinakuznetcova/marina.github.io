...
Now you have a nice lightweight vector image you can use on the web freely! But there're still some things to consider before pushing your SVG into an `img` tag. This is what I'm going to discuss with you in the [pt. II](https://healdementia.github.io/frontend-dev-svg-toolkit-pt-2).
